...
def get_response(question, keywords):
    ...
    user_question = "see the resume ["+crawled_text + ("]and extract the keywords from resume and tell me"+" what keyword will be good to add to original keywords[") + keywords+"]. please answer in korean. no additionl explanation for keywords. please analyize paragraph by paragraph."
    # gpt 응답을 리스트에 저장
    user_message = [
        {"role": "system", "content": "You are the best resume consultant expert"}
    ]
